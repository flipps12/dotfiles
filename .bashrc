...
# Definir una función para obtener la rama de git, si existe
parse_git_branch() {
    git rev-parse --abbrev-ref HEAD 2>/dev/null
}

# Personalizar el prompt (PS1)
PS1='\n\[\033[01;35m\]\u@\h\[\033[00m\] \[\e[1;32m\]$(parse_git_branch_prompt)  \n\[\033[01;34m\]\w\[\033[00m\]/ '

# Función para añadir la rama de Git al prompt si está presente
parse_git_branch_prompt() {
...
### fun
alias pipes.shh='pipes.sh -p 3 -R -t 3'
